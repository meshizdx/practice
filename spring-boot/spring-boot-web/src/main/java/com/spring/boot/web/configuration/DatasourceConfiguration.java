package com.spring.boot.web.configuration;
...
public class DatasourceConfiguration {
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean() throws Exception{
        ...
        //设置Mapper文件扫描路径
        sqlSessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:/sql/*Mapper.xml"));
